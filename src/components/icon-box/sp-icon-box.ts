...
import { getIconBoxClasses, type IconBoxVariant, type IconBoxSize } from '@phcdevworks/spectre-ui';
...
export class SpectreIconBoxElement extends SpectreProjectableElement implements SpectreIconBoxProps {
  static properties = {
...
export function defineSpectreIconBox(tagName = 'sp-icon-box'): typeof SpectreIconBoxElement {
