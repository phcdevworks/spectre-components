...
import { getGridClasses, type GridColumns, type GridGap } from '@phcdevworks/spectre-ui';
...
export function defineSpectreGrid(tagName = 'sp-grid'): typeof SpectreGridElement {
