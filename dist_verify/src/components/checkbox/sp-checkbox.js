...
export class SpectreCheckboxElement extends LitElement {
    constructor() {
        super(...arguments);
        this.ariaLabel = null;
    ...
    startContentObserver() {
        ...
        this.contentObserver = new MutationObserver((mutations) => {
            const isInternalMovement = mutations.every((mutation) => {
                return (Array.from(mutation.removedNodes).every((node) => this.isInternalCheckboxNode(node) || this.contains(node)) &&
    ...
    isInternalCheckboxNode(node) {
        return (node.nodeType === Node.ELEMENT_NODE &&
            node.hasAttribute('data-sp-checkbox-label'));
    }
    handleInput(event) {
...
export function defineSpectreCheckbox(tagName = 'sp-checkbox') {
